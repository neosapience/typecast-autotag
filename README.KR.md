...
| 태그           | 설명         | 입력                 | 출력                                            |
| -------------- | ------------ | -------------------- | ----------------------------------------------- |
| `phone`        | 전화번호     | `010-1234-5678`      | `공 일 공 다시 일 이 삼 사 다시 오 육 칠 팔`    |
...
autoTag('1588-1234', { language: 'ko' }); // → '일 오 팔 팔 다시 일 이 삼 사'
...
manualTag('name(김John)', { language: 'ko' }); // → '김 John'
