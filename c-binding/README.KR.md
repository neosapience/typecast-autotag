...
| 언어 | 상태 | 예시 |
| ---- | ---- | ---- |
| **한국어** (Korean) | ✅ 전체 지원 | `010-1234-5678` → `공 . 일 . 공 . 일 . 이 . 삼 . 사...` |
...
int main() {
    ...
    if (result) {
        printf("%s\n", result);
        // 출력: "전화번호는 공 . 일 . 공 . 일 . 이 . 삼 . 사 . 오 . 육 . 칠 . 팔 입니다."
...
// 출력: "공 . 일 . 공 . 일 . 이 . 삼 . 사 . 오 . 육 . 칠 . 팔 로 연락주세요."
...
| `phone(번호)`          | 전화번호 읽기      | `phone(010-1234-5678)` → 공 . 일 . 공 . 일 . 이...  |
